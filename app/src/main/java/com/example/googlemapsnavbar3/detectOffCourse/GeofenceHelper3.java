...
public class GeofenceHelper3 extends ContextWrapper {

    private static final String TAG = "GeofenceHelper3";
    PendingIntent pendingIntent;


    public GeofenceHelper3(Context base) {
        super(base);
    }
    ...
    public PendingIntent getPendingIntent() {
        ...
        Intent intent = new Intent(this, GeofenceBroadcastReceiver3.class);
